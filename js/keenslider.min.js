  ...
  return (
    ...
    function (t) {
      ...
      function U(t) {
        if (O && S === J(t) && ut()) {
          var e = Z(t).x;
          if (!nt(t) && E) return B(t);
          E && (Wt(), (j = e), n.setAttribute(I, !0), (E = !1)),
            t.cancelable && t.preventDefault(),
            Xt(k(j - e, $t) * (ft() ? -1 : 1), t.timeStamp),
            (j = e);
        }
      }
      function $(t) {
      ...
      function B(t) {
        O &&
          S === J(t, !0) &&
          ut() &&
          (n.removeAttribute(I), (O = !1), mt(), ot('dragEnd'));
      }
      function G(t) {
      ...
      function rt() {
        R(window, 'orientationchange', Pt),
          ...
          R(n, 'mouseleave', B),
          R(n, 'mouseup', B),
          R(n, 'touchstart', $, { passive: !0 }),
          R(n, 'touchmove', U, { passive: !1 }),
          R(n, 'touchend', B, { passive: !0 }),
          R(n, 'touchcancel', B, { passive: !0 }),
          R(window, 'wheel', et, { passive: !1 });
      }
      function it() {
      ...
      function vt(t) {
        ...
        var n = t - T,
          e = pt(n);
        if (n >= C)
          return Xt(D - X, !1), z ? z() : void ot('afterChange');
        var r = Yt(e);
        if (0 === r || ct() || st() || Y) {
          if (0 !== r && st() && !Y) return Mt();
          (X += e), Xt(e, !1), dt();
        } else Xt(e - r, !1);
      }
      function pt(t) {
      ...
      function yt() {
        if (0 === b) return !(!Yt(0) || ct()) && gt(v);
        var t = w.friction / Math.pow(Math.abs(b), -0.5);
        Ot(
      ...
      function wt() {
        ...
        var t = w.friction / Math.pow(Math.abs(b), -0.5),
          ...
          r = (K + n) / (s / l);
        Ot(
          (-1 === p ? Math.floor(r) : Math.ceil(r)) * (s / l) - K,
          e,
          function (t) {
            return 1 - Math.pow(1 - t, 5);
          }
      ...
      function Mt() {
        ...
        var t = 0.04 / Math.pow(Math.abs(b), -0.5),
          ...
          r = b;
        Ot(n, 3 * Math.abs(r / t), e, !0, function () {
          Ot(Vt(It(v)), 500, e, !0);
        });
      }
      ...
      function jt() {
        ...
        if (t === F) return !0;
        var i = (F = t) ? n[F] : H;
        i.breakpoints && F && delete i.breakpoints,
          (w = e(e(e({}, Ut), H), i)),
          (W = !0),
          (h = null),
          kt();
      ...
      function Et(t) {
        ...
        if (jt() && (e !== h || t)) {
          ...
          (k =
            ...
            (s = lt() ? n.offsetHeight : n.offsetWidth),
            (l = At(w.slidesPerView)),
      ...
      function Tt() {
        it(),
          Lt(),
          n && n.hasAttribute(V) && n.removeAttribute(V),
          ot('destroyed');
      }
      function Dt() {
        f &&
        ...
        f &&
          f.forEach(function (t) {
            var n = 'calc('
              ...
              .concat((d / l) * (l - 1), 'px)');
            lt()
              ? ((t.style['min-height'] = n),
                (t.style['max-height'] = n))
              : ((t.style['min-width'] = n),
                (t.style['max-width'] = n));
          });
      }
      ...
      function Ft(t, n) {
        ...
        if (
          (e !== p && Wt(),
          (p = e),
          N.push({ distance: t, time: n }),
          (m = setTimeout(function () {
            (N = []), (b = 0);
          }, 50)),
          (N = N.slice(-6)).length <= 1 || 0 === p)
        )
          return (b = 0);
      ...
      function _t() {
        ...
        for (var t = [], n = 0; n < o; n++) {
          var e =
            (((1 / o) * n - (y < 0 && ct() ? y + 1 : y)) * o) / l + c;
          ct() &&
            (e +=
              e > (o - 1) / l ? -o / l : e < -o / l + 1 ? o / l : 0);
          var r = 1 / l,
            i = e + r,
            a = i < r ? i / r : i > 1 ? 1 - ((i - 1) * l) / 1 : 1;
          t.push({
            portion: a < 0 || a > 1 ? 0 : a,
            distance: ft() ? -1 * e + 1 - r : e,
          });
        }
        (g = t), Dt(), ot('move');
      }
